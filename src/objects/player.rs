...
pub fn move_player(pos: &mut glam::Vec2, keycode: KeyCode, x_dir: f32, ctx: &mut Context, PLAYER_WIDTH: f32, SCALE: f32) {
    ...
    limit_boundaries(&mut pos.x, 0.0, MAX_WIDTH - PLAYER_WIDTH*SCALE);
}
